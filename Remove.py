...
Each line contains two space-separated integers n and x (1 ≤ x < n ≤ 10^9) — the length of the list and the position we wonder about. 
It's guaranteed that after the algorithm ends, the list will still contain at least x numbers.
