...
------------------------------------ Link for the challenge: https://codeforces.com/problemset/problem/2155/A ------------------------------------


Juan and his friends are going to split themselves into n teams and play a modified double-elimination football tournament, consisting of a winners' group and a losers' group. 
Initially, all teams belong to the winners' group.
...
The only line of each test case contains one positive integer n (2 ≤ n ≤ 500) — the number of teams.
