...
----------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/1822/C -----------------------------------------

Tema loves cinnabon rolls — buns with cinnabon and chocolate in the shape of a "snail".

Cinnabon rolls come in different sizes and are square when viewed from above. The most delicious part of a roll is the chocolate, 
which is poured in a thin layer over the cinnabon roll in the form of a spiral and around the bun, as in the following picture:
...
Formally, the bun consists of two dough spirals separated by chocolate. 
A cinnabon roll of size n+1 is obtained from a cinnabon roll of size n by wrapping each of the dough spirals around the cinnabon roll for another layer.
...
Each test case is described by a single integer n (4 ≤ n ≤ 10^9) — the size of the cinnabon roll.
