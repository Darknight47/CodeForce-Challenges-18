...
------------------------------------------------------ Link for the challenge: https://codeforces.com/problemset/problem/1875/A ------------------------------------------

Flowey has planted a bomb in Snowdin!

The bomb has a timer that is initially set to b. Every second, the timer will decrease by 1. 
...
However, if the timer is changed to an integer larger than a, the timer will be set to a due to a bug.
...
for _ in range(cases):
    maxValue, init, n = map(int, input().split())
