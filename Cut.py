...
However, these ways to draw the line are not suitable (the first line cuts the triangle into a triangle and a quadrangle; the second line doesn't cut the triangle at all; 
the third line is neither horizontal nor vertical):

Input
The first line contains one integer t (1 ≤ t ≤ 10^4) — the number of test cases.

Each test case consists of four lines. The first of them is empty. 
The i-th of the next three lines contains two integers xi and yi (1 ≤ xi, yi ≤ 10^8) — the coordinates of the i-th vertex of the triangle.
...
Output
For each test case, print YES if it is possible to cut the triangle according to the statement, or NO otherwise. 
...
for _ in range(cases):
    ...
    if(len({x1, x2, x3}) == 3 or len({y1, y2, y3}) == 3):
        print("YES")
    else:
        print("NO")